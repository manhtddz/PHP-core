                    ...
                    <nav>
                        <ul class="pagination">
                            ...
                            <li class="page-item <?= $page == 1 ? 'disabled' : '' ?>">
                                <a class="page-link" href="?controller=user&page=1&sort=<?= $sort ?>">«
                                    First</a>
                            </li>
                            ...
                            <li class="page-item <?= $page == $totalPages ? 'disabled' : '' ?>">
                                <a class="page-link" href="?controller=user&page=<?= $page + 1 ?>&sort=<?= $sort ?>">Next
                                    »</a>
                            </li>

                            <!-- Nút Last -->
                            <li class="page-item <?= $page == $totalPages ? 'disabled' : '' ?>">
                                <a class="page-link" href="?controller=user&page=<?= $totalPages ?>&sort=<?= $sort ?>">Last
                                    »</a>
                            </li>
                        </ul>
                    </nav>
